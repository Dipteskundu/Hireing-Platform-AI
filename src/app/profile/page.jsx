...
import { MapPin, Send, Mail, Phone, Globe, Award, BookOpen, Briefcase, User, CheckCircle } from "lucide-react";
              ...
              <div className="bg-white rounded-[2.5rem] border border-slate-100 premium-shadow p-8 lg:sticky lg:top-32">
                <div className="flex flex-col items-center text-center space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-indigo-600 font-bold mt-1 uppercase tracking-wider text-xs">{title}</p>
                  </div>
                  ...
                  <div className="flex gap-4 w-full pt-4">
                    <Link href="/profile/edit" className="flex-1 flex items-center justify-center gap-2 bg-slate-900 text-white font-bold py-3.5 rounded-2xl premium-shadow hover:bg-slate-800 transition-all active:scale-95">
                ...
                <>
                  ...
                  <section className="space-y-6">
                    <div className="flex items-center gap-3">
                      ...
                      <h2 className="text-2xl font-bold text-slate-900">Core Expertise</h2>
                    </div>
                            ...
                            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 mt-6 text-sm font-medium">
                                ...
                                {profile.isSkillVerified && (
                                     <span className="flex items-center gap-2 px-4 py-2 bg-emerald-500/20 text-emerald-100 rounded-xl font-bold border border-emerald-400/30 backdrop-blur-md shadow-[0_0_15px_rgba(16,185,129,0.3)]">
                                         <CheckCircle className="w-4 h-4 text-emerald-400" /> Skill Verified
                                     </span>
                                )}
                            </div>
                            {project.link && (
